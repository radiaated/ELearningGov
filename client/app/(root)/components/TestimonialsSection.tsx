...
const TestimonialItem = ({
  ...
  return (
    <div>
      ...
      <div className="text-right mr-4">- {testimonial.author}</div>
    </div>
  );
};
            ...
            <div className="embla__container">
              {testi.map((test, idx) => (
                <div className="embla__slide" key={idx}>
                  <TestimonialItem testimonial={test} />
                </div>
              ))}
            </div>
          </div>
          <div className="embla__control">
            <button className="embla__control-left" onClick={scrollPrev}>
              <i className="fa-solid fa-angle-left"></i>
            </button>
            <button className="embla__control-right" onClick={scrollNext}>
